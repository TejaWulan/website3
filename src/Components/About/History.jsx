  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* TITLE */}
        <h1 className="text-3xl md:text-5xl lg:text-6xl font-black text-white mb-10 leading-tight uppercase">
        ...
        <div className="text-gray-200 space-y-6 leading-relaxed text-[15px] md:text-lg text-left">
          <p className="font-medium">
            <strong className="text-white font-extrabold">PT Milenial Sukses Coalindo</strong> didirikan dengan semangat anak-anak muda untuk membangun perusahaan yang modern, adaptif, dan berorientasi pada hubungan kerja sama jangka panjang.
          </p>

          <p className="font-medium">
            Pada tahap awal operasional, perusahaan telah membangun jaringan <span className="text-[#e67e22] font-bold italic">supplier</span> dan <span className="text-[#e67e22] font-bold italic">buyer</span> serta mulai menjalankan aktivitas perdagangan batubara untuk pasar domestik.
          </p>

          <p className="font-medium">
            Dengan dukungan relasi yang terus berkembang, dan koordinasi distribusi yang terintegrasi, kami berkomitmen menjaga kelancaran pasokan batubara secara konsisten dan tepat waktu.
          </p>
