...
import Poster1 from "../../assets/img/company/trucktanpateks.png";
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16 lg:gap-24 max-w-7xl mx-auto">
                ...
                >
                    <div className="relative max-w-[260px] sm:max-w-[300px] lg:max-w-[340px] w-[80%] md:w-full">
                        <img
                            src={Poster1}
                            alt="About PT Milenial Sukses Coalindo"
                ...
                >
                    ...
                    <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-[#2f2f2f] leading-tight mb-6 uppercase">
                        PT MILENIAL SUKSES COALINDO
                    </h2>

                    <div className="text-gray-600 leading-relaxed text-[15px] md:text-base space-y-5 font-medium">
                        <p>
                            <strong className="text-[#424651] font-extrabold">PT Milenial Sukses Coalindo</strong> adalah perusahaan perdagangan batubara yang berfokus pada penyediaan pasokan energi untuk sektor industri dan pembangkit listrik di Indonesia.
                        </p>
                        <p>
